#! /bin/bash
# Script to run all SeoulAir microservices at once.
...
#Starting SeoulAir Device
docker-compose -f $root_dir/seoulair-device/docker-compose.yml kill
docker-compose -f $root_dir/seoulair-device/docker-compose.yml up -d --build

#Starting SeoulAir Command
docker-compose -f $root_dir/seoulair-command/docker-compose.yml kill
docker-compose -f $root_dir/seoulair-command/docker-compose.yml up -d --build

#Starting SeoulAir Analytics
docker-compose -f $root_dir/seoulair-analytics/docker-compose.yml kill
docker-compose -f $root_dir/seoulair-analytics/docker-compose.yml up -d --build

#Starting SeoulAir Data
docker-compose -f $root_dir/seoulair-data/docker-compose.yml kill
docker-compose -f $root_dir/seoulair-data/docker-compose.yml up -d --build

#Starting SeoulAir Gateway
docker-compose -f $root_dir/seoulair-gateway/docker-compose.yml kill
docker-compose -f $root_dir/seoulair-gateway/docker-compose.yml up -d --build

#Starting SeoulAir Data
docker-compose -f $root_dir/seoulair-dashboard/docker-compose.yml kill
docker-compose -f $root_dir/seoulair-dashboard/docker-compose.yml up -d --build
